    ...
    <>
      <article className="resume max-w-2xl p-6 mx-auto max-w-a4 xsm:p-8 sm:p-9 md:p-16">
        ...
        <header className="flex-col items-center mb-8 md:mb-11">
          <h1 className="text-5xl font-semibold ">兰天游</h1>
        </header>
        <section>
          ...
          <div className="col-break-avoid">
            <section className="mb-4 col-break-avoid">
              <ul className="my-2 mb-6 flex flex-wrap text-md leading-relaxed">
                <li className="px-3 mr-1.5 mt-1.5 text-base  print:bg-white print:border-inset bg-gray-200">
                  JavaScript
                </li>
                <li className="px-3 mr-1.5 mt-1.5 text-base  print:bg-white print:border-inset bg-gray-200">
                  React
        ...
        <section className="mt-8">
          <div className="col-break-avoid">
            <h2 className="mb-4 font-bold tracking-widest text-2xl  print:font-normal">
              项目
            </h2>

            <section className="mb-4 col-break-avoid">
              <header>
                <h3 className="text-lg font-semibold  leading-snugish">电商</h3>
              ...
              <p className="mt-2 text-md  leading-normal">
                利用Next.JS
                实现了全局布局设计，让导航栏显示加载时进度条，利用CSS实现购物车的折叠和弹出，对各个React
                Component用Jest简单测试，主要难点在于全部商品页的Pagination
              </p>
              <p className="mt-2 text-md  leading-normal">
                独立设计GraphQL
                schema以便前后端分离开发，利用Stripe实现支付，整个数据库用Docker容器化
              </p>
            </section>
          </div>
          <section className="mb-4 col-break-avoid">
            ...
            <p className="pl-7 mt-2 text-md  leading-normal">
              了解函数式编程语言自学Phoenix
              框架开发流程，实现了用GitHub账号登陆，难点在于用Socket.io实现每个聊天室的实时对话
            </p>
          </section>
        </section>
