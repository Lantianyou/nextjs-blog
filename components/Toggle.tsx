...
const Toggle = ({ darkThemeEnabled }) => {
  ...
  return (
    <button aria-label='切换暗色模式' onClick={() => dispatch({ type: TOGGLE_DARKTHEME })} style={{ height: '30px' }} className={cn('my-auto', { 'bg-gray-600': darkThemeEnabled }, { 'bg-gray-100': !darkThemeEnabled })} >
